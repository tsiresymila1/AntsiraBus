            ...
            <View style={styles.center}>
                <View style={{ flexDirection : 'column', justifyContent : 'center', flex:1 }}>
                    ...
                    <View style={{ height: 40, marginLeft: 140, marginRight: 140, justifyContent: "center"}}>
                        <Text style={{ textAlign: 'center', color: "#1f064f", fontWeight:'bold', fontSize: 18, textTransform: 'uppercase'}}>Nouveau mot de passe</Text>
                    </View>
                    ...
                    <View style={{ marginLeft: 140, marginRight: 140, marginTop: 18}}>
                        <Button icon={"check"} style={{ marginTop : 12, height: 40, backgroundColor:"#1f064f" }} mode="contained" onPress={() =>{
