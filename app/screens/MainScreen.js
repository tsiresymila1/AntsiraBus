...
const MainScreen = ({navigation}) => {
  return (
    <>
      <StatusBar translucent={false} backgroundColor={'#1a237ef5'} />
      <Drawer.Navigator drawerContent={DrawerContent}>
        <Drawer.Screen
          options={{
            header: drawerprops => (
              <MainAppBar {...drawerprops} logged={true} />
            ),
          }}
          name="Content"
          component={Content}
        ...
        />
        <Drawer.Screen
          options={{header: SelectAppBar}}
          name="Detail"
          component={() => <DetailsScreen mainnav={navigation} />}
        />
      </Drawer.Navigator>
    </>
  );
