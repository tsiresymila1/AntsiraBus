      ...
      <View
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-evenly'}}>
          <View style={{flexDirection: 'row'}}>
            <Checkbox color="green" status={'checked'} onPress={() => {}} />
            <Text style={{marginTop: 8}}>Disponible </Text>
          </View>
          <View style={{flexDirection: 'row'}}>
            <Checkbox color="grey" status={'checked'} onPress={() => {}} />
            <Text style={{marginTop: 8}}>Indisponible </Text>
          </View>
          <View style={{flexDirection: 'row'}}>
            <Checkbox color="#1f064f" status={'checked'} onPress={() => {}} />
            <Text style={{marginTop: 8}}>Selectionné </Text>
          </View>
        </View>
        <View
          style={{
          ...
          <FlatList
            ...
            renderItem={({item}) => (
              <SeatItem
                isDriver={item.index === 1}
                key={item.index}
                notshowing={item.index === 2}
                indice={item.index}
                onChangeState={state => changeState(state, item.index)}
                state={item.state}
              />
            )}
            numColumns={3}
      ...
      <View
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
          ...
          <View
            ...
            <Button
              disabled={mySeat.length === 0}
              icon={'arrow-right-bold'}
              style={{
                marginTop: 0,
                backgroundColor: '#1f064f',
              }}
