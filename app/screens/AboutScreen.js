    ...
    return (
        <>
            ...
            <Appbar.Header>
                ...
                <Appbar.Content title="A propos" titleStyle={{ fontSize: 18, alignItems: 'center' }} />
            </Appbar.Header>
            <View style={styles.center}>
                <View style={{ flexDirection : 'column', justifyContent: 'flex-start', flex:1 }}>
                    ...
                    <View style={{ height: 40, marginLeft: 140, marginRight: 140, justifyContent: "center"}}>
                        <Text style={{ textAlign: 'center', color: "#1f064f", fontWeight:'bold', fontSize: 18, textTransform: 'uppercase'}}>Déscription</Text>
                    </View>
                    <View style={{ height: 40, marginLeft: 140, marginRight: 140, justifyContent: "center"}}>
                        <Text style={{ textAlign: 'justify', fontSize: 14}}>
                            Application de réservation des places en ligne. Permet de choisir des places parmis les disponibles
                        </Text>
                    </View>
                </View>
